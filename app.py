...
# --- PHASE 7: RESEARCH PAPER REPORTING ---
st.divider()
st.title("📊 COMPLETE TABLE GUIDE FOR RESEARCH PAPER")
st.info("This section formats your analysis into professional tables suitable for publication.")

if 'df_final' in locals() and 'audpc_results' in locals():
